...
INSERT INTO  rating(ratingProfileId, ratingMovieId, ratingDate) VALUES (UNHEX('5c13630935034491badc4aab0fef9395'), UNHEX('df1018f52a3b411daf476322b720abf8'), '2019');


update profile set profileFirstName = 'Piyuewh'WHERE profileId = UNHEX('5c13630935034491badc4aab0fef9395');
...
INSERT INTO movie(movieId, movieName, movieRating, movieSummary, movieYear) VALUES (UNHEX('1257e827ef634c77b3d5f1b121100866'), 'Eden of the East', '7', 'This one guy is naked with a gun in front of the white house. Why? Who knows. Certainly
not him', '2012');
INSERT INTO rating(ratingProfileId, ratingMovieId, ratingDate) VALUES (UNHEX('f19b4aa826d243b698c09b893d4f8668'), UNHEX('1257e827ef634c77b3d5f1b121100866'), '2015');

Select movieName, movieYear from movie where movieId = UNHEX('1257e827ef634c77b3d5f1b121100866');

select profile.profileFirstName, profile.profileLastName, rating.ratingDate FROM profile INNER JOIN rating on rating.ratingProfileId = profile.profileId where profileLastName = 'Mashke';


SELECT SUM(likeTweetId) FROM like;
